...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Luccas", "Luccas@gmail.com", new DateTime(1995, 2, 13), 1500.0, d2);
            Seller s3 = new Seller(3, "Pedro", "Pedro@gmail.com", new DateTime(1990, 4, 21), 1060.0, d1);
            Seller s4 = new Seller(4, "Jessica", "Jessica@gmail.com", new DateTime(1988, 3, 21), 10990.0, d4);
            Seller s5 = new Seller(5, "Cinara", "Cinara@gmail.com", new DateTime(1978, 6, 21), 1050.0, d3);
            Seller s6 = new Seller(6, "Adriano", "Adriano@gmail.com", new DateTime(1968, 10, 21), 1010.0, d2);
